...
if (! class_exists('LyraResponse', false)) {
    ...
    class LyraResponse
    {
        ...
        {
            return in_array($this->transStatus, LyraApi::getSuccessStatuses()) || $this->isPendingPayment();
        }
        ...
        {
            return in_array($this->transStatus, LyraApi::getPendingStatuses());
        }
        ...
        {
            return in_array($this->transStatus, LyraApi::getCancelledStatuses());
        }
        ...
        {
            return in_array($this->transStatus, LyraApi::getToValidateStatuses());
        }
